...
func (tc *TagCreate) SetType(s string) *TagCreate {
	tc.mutation.SetType(s)
	return tc
}

// SetNillableType sets the "type" field if the given value is not nil.
func (tc *TagCreate) SetNillableType(s *string) *TagCreate {
	if s != nil {
		tc.SetType(*s)
	}
	return tc
...
func (tc *TagCreate) SetCategory(t tag.Category) *TagCreate {
	tc.mutation.SetCategory(t)
	return tc
}

// SetNillableCategory sets the "category" field if the given value is not nil.
func (tc *TagCreate) SetNillableCategory(t *tag.Category) *TagCreate {
	if t != nil {
		tc.SetCategory(*t)
	}
	return tc
